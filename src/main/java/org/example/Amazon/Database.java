...
/**
 * This is a very naive database connection class. In real life, you should make use of a decent
 * database API, such as Spring Data or Hibernate.
 */
        ...
        () -> {
          ...
          try (var preparedStatement =
              connection.prepareStatement(
                  "create table if not exists shoppingcart (type varchar(100), name varchar(100), "
